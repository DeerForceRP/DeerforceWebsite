...
window.addEventListener("load", function(){
    document.getElementById('txtExtras').value = getSaved;
    var table = document.getElementById("mainTable");

	if(getFlipped == "1")
	{
	    document.getElementById('chkFlipFine').checked = true;
	}
	else
	{
	    document.getElementById('chkFlipFine').checked = false;
	}

	document.querySelector('#searchCrime').addEventListener('keyup', searchCrimes, false);
